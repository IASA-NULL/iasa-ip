    ...
    "conditions": [
      ...
      ["USE_ADDITIONAL_WINMD==\"true\"", {
        "msvs_settings": {
          "VCCLCompilerTool": {
            "AdditionalUsingDirectories": [
              "%ProgramFiles%/Windows Kits/10/UnionMetadata/10.0.15063.0",
              "%ProgramFiles%/Windows Kits/10/Include/10.0.15063.0/um",
              "%ProgramFiles(x86)%/Windows Kits/10/UnionMetadata/10.0.15063.0",
